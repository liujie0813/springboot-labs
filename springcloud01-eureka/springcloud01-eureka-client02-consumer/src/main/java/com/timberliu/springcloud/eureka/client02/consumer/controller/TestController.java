package com.timberliu.springcloud.eureka.client02.consumer.controller;
...
public class TestController {
    ...
    public String test(String name) {
        ...
        if (true) {
            List<ServiceInstance> instances = discoveryClient.getInstances("client02-provider");
            serviceInstance = instances.size() > 0 ? instances.get(0) : null;
        } else {
            serviceInstance = loadBalancerClient.choose("client02-provider");
        }
